...
class NotificationService {
  ...
  Future<void> scheduleReminder(Todo todo) async {
    if (!_isInitialized || !todo.reminderEnabled || todo.reminderTime == null) {
      debugPrint(
          'Cannot schedule reminder: initialized=$_isInitialized, enabled=${todo.reminderEnabled}, time=${todo.reminderTime}');
      return;
    }
